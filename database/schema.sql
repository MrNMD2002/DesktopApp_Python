...
CREATE TABLE users (
    ...
    role ENUM('question_creator', 'exam_generator', 'student') NOT NULL,
...
('admin', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewdBPj4J/HS.iQeO', 'Administrator', 'exam_generator'),

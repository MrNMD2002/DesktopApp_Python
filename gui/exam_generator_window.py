...
class ExamGeneratorWindow:
    ...
    def setup_ui(self):
        ...
        ttk.Label(duration_frame, text="(15-180 phút)", font=("Arial", 8), foreground="gray").pack(side=tk.LEFT, padx=(5, 0))
    ...
    def delete_exam_by_id(self, exam_id):
        ...
        try:
            ...
            if result:
                ...
                messagebox.showinfo("✅ Thành công", f"Đã xóa đề thi {exam_code} thành công!\n\n🔄 Đang làm mới danh sách đề thi...")
    ...
    def _open_edit_subject_dialog(self, parent_dialog, subject_id, subject_name):
        ...
        # Form fields
        ttk.Label(frame, text="Tên môn học:", font=("Arial", 10, "bold")).grid(row=0, column=0, sticky="w", pady=8, padx=(0, 10))
        ...
        ttk.Label(frame, text="Mã môn học:", font=("Arial", 10, "bold")).grid(row=1, column=0, sticky="w", pady=8, padx=(0, 10))
        ...
        ttk.Label(frame, text="Mô tả:", font=("Arial", 10, "bold")).grid(row=2, column=0, sticky="w", pady=8, padx=(0, 10))
